...
class Employee:
    ...
    # Add department_id to the parameters
    # store the self value in the name department_id
    # update __repr__ to include this value
    ...
    @classmethod
    #1 add (INSERT) a column named department_id 
    #2 store relationship (department_id value) as a foreign key in "employees table" (department(id)). Thus, the values of department_id column will become the department(id) when an employee instance is created
    ...
    def save(self):
        ...
        # store new department_id relationship in emplyees table 
        sql = """
